...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const navItems = [
    { href: "/admin/dashboard", icon: <IoCart />, label: "Dashboard" },
    { href: "/admin/users", icon: "fa-shopping-basket", label: "Users" },
    { href: "/admin/agents", icon: "fa-shopping-cart", label: "Agents" },
    { href: "/admin/shopowner", icon: "fa-users", label: "Shop Owner" },
    { href: "/admin/orders", icon: "fa-tag", label: "Orders" },
    { href: "/admin/orders-history", icon: "fa-tag", label: "Order History" },
  ];
